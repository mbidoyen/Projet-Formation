...
$datas = file_get_contents('https://fr.dofus.dofapi.fr/pets/'.$_POST["id"]);// Fais appel à l'API sur une URL
...
function ajouterUnObjet($id, $type){
    ...
    if(creationEquipement() && !isVerrouille()){
        ...
        if($TypeObjet !== false){
            ...
            echo "Vous avez déjà un objet du même type dans votre équipement <br />";  
        }
           ...
           echo "L'objet a été ajouté dans votre équipement <br />";
        }
